...
def get_args():
    ...
    parser.add_argument("--display-player", action="store_true", help="Display player summaries.")
    parser.add_argument("--display-inventory", action="store_true", help="Display {BUNDLE, COURIER, HERO_BUNDLE, WARD, WEATHER} items.")
    parser.add_argument("--display-inventory-full", action="store_true", help="Display also {HERO, MISC} items.")
